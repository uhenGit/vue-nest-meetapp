...
import { isAuthor, isValidEmail, getDateStr, setPosition, toRawDeep } from '@/utils';
...
export default {
  ...
  mounted() {
    ...
    if (!this.eventDay) {
      this.event = toRawDeep(this.eventData);
          ...
          <tr class="leading-5 border-b-2">
            ...
            >
              ...
              >
                <chip-element
                  :content="participant"
                  :removable="isAuthor && participant !== user.userEmail"
          ...
          <tr class="leading-5 border-b-2">
            ...
            <td class="pb-1.5">
              ...
              <label
                ...
                :class="{ 'hover:cursor-not-allowed': !isAuthor }"
